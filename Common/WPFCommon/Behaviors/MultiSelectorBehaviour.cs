...
namespace Common.WPFCommon.Behaviors
{
	...
	public static class MultiSelectorBehaviour
	{
		public static readonly DependencyProperty SynchronizedSelectedItems = DependencyProperty.RegisterAttached(
			"SynchronizedSelectedItems", typeof(IList), typeof(MultiSelectorBehaviour),
		...
		private static readonly DependencyProperty SynchronizationManagerProperty = DependencyProperty.RegisterAttached(
			"SynchronizationManager", typeof(SynchronizationManager), typeof(MultiSelectorBehaviour),
		...
		private class SynchronizationManager
		{
			...
			private ListSynchronizer _synchronizer;
