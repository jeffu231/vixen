...
namespace Common.WPFCommon.Utils
{
	...
	public class ListSynchronizer : IWeakEventListener
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ListSynchronizer"/> class.
		/// </summary>
		/// <param name="masterList">The master list.</param>
		/// <param name="targetList">The target list.</param>
		/// <param name="masterTargetConverter">The master-target converter.</param>
		public ListSynchronizer(IList masterList, IList targetList, IListItemConverter masterTargetConverter)
		{
		...
		/// <param name="masterList">The master list.</param>
		/// <param name="targetList">The target list.</param>
		public ListSynchronizer(IList masterList, IList targetList)
